class AdburndownController < ApplicationController
  ...
  def show
	...
	logger.debug ActiveRecord::Base.connection.adapter_name.to_yaml
    if ActiveRecord::Base.connection.adapter_name == 'MySQL' or ActiveRecord::Base.connection.adapter_name == 'MySQL2'
